...
static uc_test_err uc_tok_equals_returns_true_if_strings_are_equal(uc_test_group *p) {
    ...
    uc_tok *ptr = "value";
    UC_TEST_ASSERT(UC_TRUE == uc_tok_equals(ptr, value1));
    UC_TEST_ASSERT(UC_TRUE == uc_tok_equals(ptr, value2));
    return UC_TEST_ERR_NONE;
}
...
static uc_test_err uc_tok_equals_returns_true_for_nulls(uc_test_group *p) {
    char  *value = NULL;
    uc_tok *ptr = NULL;
    UC_TEST_ASSERT(UC_TRUE == uc_tok_equals(ptr, value));
    return UC_TEST_ERR_NONE;
}
...
static uc_test_err uc_tok_equals_returns_false_if_strings_are_different(uc_test_group *p) {
    ...
    uc_tok *ptr = "valuu";
    UC_TEST_ASSERT(UC_FALSE == uc_tok_equals(ptr, value1));
    UC_TEST_ASSERT(UC_FALSE == uc_tok_equals(ptr, value2));
    return UC_TEST_ERR_NONE;
}
...
static uc_test_err uc_tok_equals_returns_false_if_either_arg_is_null(uc_test_group *p) {
    char *value = "value";
    uc_tok *ptr = NULL;
    UC_TEST_ASSERT(UC_FALSE == uc_tok_equals(ptr, value));
...
static uc_test_err uc_tok_is_numeric_returns_true_for_numbers(uc_test_group *p) {
    ...
    UC_TEST_ASSERT(UC_TRUE == uc_tok_is_numeric((uc_tok*)"1"));
    UC_TEST_ASSERT(UC_TRUE == uc_tok_is_numeric((uc_tok*)"1.2"));
    UC_TEST_ASSERT(UC_TRUE == uc_tok_is_numeric((uc_tok*)"87"));
    UC_TEST_ASSERT(UC_TRUE == uc_tok_is_numeric((uc_tok*)"-1"));
    UC_TEST_ASSERT(UC_TRUE == uc_tok_is_numeric((uc_tok*)n1));
    UC_TEST_ASSERT(UC_TRUE == uc_tok_is_numeric((uc_tok*)"-543.234610"));
    return UC_TEST_ERR_NONE;
}

static uc_test_err uc_tok_is_numeric_returns_false_for_non_numbers(uc_test_group *p) {
    char c1[] = { '4', '8', '.', '9', '1', 'n', 'a', '\0' };
    UC_TEST_ASSERT(UC_FALSE == uc_tok_is_numeric((uc_tok*)"a"));
    UC_TEST_ASSERT(UC_FALSE == uc_tok_is_numeric((uc_tok*)"1234_"));
    UC_TEST_ASSERT(UC_FALSE == uc_tok_is_numeric((uc_tok*)"1_234"));
    UC_TEST_ASSERT(UC_FALSE == uc_tok_is_numeric((uc_tok*)c1));
    UC_TEST_ASSERT(UC_FALSE == uc_tok_is_numeric((uc_tok*)NULL));
    return UC_TEST_ERR_NONE;
}

static uc_test_err uc_tok_is_switch_returns_true_for_switches(uc_test_group *p) {
    char s1[] = { '-', 's', '1', '\0', 'n', 'a', '\0' };
    UC_TEST_ASSERT(UC_TRUE == uc_tok_is_switch((uc_tok*)"-switch"));
    UC_TEST_ASSERT(UC_TRUE == uc_tok_is_switch((uc_tok*)"--double"));
    UC_TEST_ASSERT(UC_TRUE == uc_tok_is_switch((uc_tok*)"-em-bed"));
    UC_TEST_ASSERT(UC_TRUE == uc_tok_is_switch((uc_tok*)s1));
    UC_TEST_ASSERT(UC_TRUE == uc_tok_is_switch((uc_tok*)"-1.23.4"));
    return UC_TEST_ERR_NONE;
}

static uc_test_err uc_tok_is_switch_returns_false_for_non_switches(uc_test_group *p) {
    char a1[] = { 'a', 'r', 'g', '-', 'd', 'a', 's', 'h', '\0' };
    UC_TEST_ASSERT(UC_FALSE == uc_tok_is_switch((uc_tok*)"arg"));
    UC_TEST_ASSERT(UC_FALSE == uc_tok_is_switch((uc_tok*)"e-mbed"));
    UC_TEST_ASSERT(UC_FALSE == uc_tok_is_switch((uc_tok*)"-1"));
    UC_TEST_ASSERT(UC_FALSE == uc_tok_is_switch((uc_tok*)"-1.234"));
    UC_TEST_ASSERT(UC_FALSE == uc_tok_is_switch((uc_tok*)a1));
    UC_TEST_ASSERT(UC_FALSE == uc_tok_is_switch((uc_tok*)NULL));
    return UC_TEST_ERR_NONE;
}
