...
static ucTestErr ucTok_get_length_returns_string_length(ucTestGroup *p) {
    char s[] = { 'h', 'e', 'l', 'l', 'o', '\0' };
    ucTok *ptr = s;
    UC_TEST_ASSERT(ucTok_get_length(ptr) == strlen(s));
    return ucTestErr_NONE;
}

static ucTestErr ucTok_get_length_returns_zero_for_empty_token(ucTestGroup *p) {
    UC_TEST_ASSERT(0 == ucTok_get_length((ucTok*)""));
    UC_TEST_ASSERT(0 == ucTok_get_length((ucTok*)NULL));
    return ucTestErr_NONE;
}
...
static ucTestErr ucTok_get_length_ignores_chars_trailing_separator(ucTestGroup *p) {
    ...
    ucTok *ptr = s;
    UC_TEST_ASSERT(3 == ucTok_get_length(ptr));
    return ucTestErr_NONE;
}
...
static ucTestErr ucTok_get_value_returns_string_value(ucTestGroup *p) {
    ...
    ucTok *ptr = s;
    UC_TEST_ASSERT(ucTok_get_value(ptr));
    return ucTestErr_NONE;
}
...
static ucTestErr ucTok_equals_returns_true_if_strings_are_equal(ucTestGroup *p) {
    ...
    ucTok *ptr = "value";
    UC_TEST_ASSERT(ucBool_true == ucTok_equals(ptr, value1));
    UC_TEST_ASSERT(ucBool_true == ucTok_equals(ptr, value2));
    return ucTestErr_NONE;
}
...
static ucTestErr ucTok_equals_returns_true_for_nulls(ucTestGroup *p) {
    char  *value = NULL;
    ucTok *ptr = NULL;
    UC_TEST_ASSERT(ucBool_true == ucTok_equals(ptr, value));
    return ucTestErr_NONE;
}
...
static ucTestErr ucTok_equals_returns_false_if_strings_are_different(ucTestGroup *p) {
    ...
    ucTok *ptr = "valuu";
    UC_TEST_ASSERT(ucBool_false == ucTok_equals(ptr, value1));
    UC_TEST_ASSERT(ucBool_false == ucTok_equals(ptr, value2));
    return ucTestErr_NONE;
}
...
static ucTestErr ucTok_equals_returns_false_if_either_arg_is_null(ucTestGroup *p) {
    char *value = "value";
    ucTok *ptr = NULL;
    UC_TEST_ASSERT(ucBool_false == ucTok_equals(ptr, value));
...
static ucTestErr ucTok_is_numeric_returns_true_for_numbers(ucTestGroup *p) {
    ...
    UC_TEST_ASSERT(ucBool_true == ucTok_is_numeric((ucTok*)"1"));
    UC_TEST_ASSERT(ucBool_true == ucTok_is_numeric((ucTok*)"1.2"));
    UC_TEST_ASSERT(ucBool_true == ucTok_is_numeric((ucTok*)"87"));
    UC_TEST_ASSERT(ucBool_true == ucTok_is_numeric((ucTok*)"-1"));
    UC_TEST_ASSERT(ucBool_true == ucTok_is_numeric((ucTok*)n1));
    UC_TEST_ASSERT(ucBool_true == ucTok_is_numeric((ucTok*)"-543.234610"));
    return ucTestErr_NONE;
}

static ucTestErr ucTok_is_numeric_returns_false_for_non_numbers(ucTestGroup *p) {
    char c1[] = { '4', '8', '.', '9', '1', 'n', 'a', '\0' };
    UC_TEST_ASSERT(ucBool_false == ucTok_is_numeric((ucTok*)"a"));
    UC_TEST_ASSERT(ucBool_false == ucTok_is_numeric((ucTok*)"1234_"));
    UC_TEST_ASSERT(ucBool_false == ucTok_is_numeric((ucTok*)"1_234"));
    UC_TEST_ASSERT(ucBool_false == ucTok_is_numeric((ucTok*)c1));
    UC_TEST_ASSERT(ucBool_false == ucTok_is_numeric((ucTok*)NULL));
    return ucTestErr_NONE;
}

static ucTestErr ucTok_is_switch_returns_true_for_switches(ucTestGroup *p) {
    char s1[] = { '-', 's', '1', '\0', 'n', 'a', '\0' };
    UC_TEST_ASSERT(ucBool_true == ucTok_is_switch((ucTok*)"-switch"));
    UC_TEST_ASSERT(ucBool_true == ucTok_is_switch((ucTok*)"--double"));
    UC_TEST_ASSERT(ucBool_true == ucTok_is_switch((ucTok*)"-em-bed"));
    UC_TEST_ASSERT(ucBool_true == ucTok_is_switch((ucTok*)s1));
    UC_TEST_ASSERT(ucBool_true == ucTok_is_switch((ucTok*)"-1.23.4"));
    return ucTestErr_NONE;
}

static ucTestErr ucTok_is_switch_returns_false_for_non_switches(ucTestGroup *p) {
    char a1[] = { 'a', 'r', 'g', '-', 'd', 'a', 's', 'h', '\0' };
    UC_TEST_ASSERT(ucBool_false == ucTok_is_switch((ucTok*)"arg"));
    UC_TEST_ASSERT(ucBool_false == ucTok_is_switch((ucTok*)"e-mbed"));
    UC_TEST_ASSERT(ucBool_false == ucTok_is_switch((ucTok*)"-1"));
    UC_TEST_ASSERT(ucBool_false == ucTok_is_switch((ucTok*)"-1.234"));
    UC_TEST_ASSERT(ucBool_false == ucTok_is_switch((ucTok*)a1));
    UC_TEST_ASSERT(ucBool_false == ucTok_is_switch((ucTok*)NULL));
    return ucTestErr_NONE;
}

static ucTestErr ucTok_get_next_returns_next_token(ucTestGroup *p) {
    UC_TEST_ASSERT(ucTok_equals(ucTok_get_next((ucTok*)"t1\0t2"), "t2"));
    UC_TEST_ASSERT(ucTok_equals(ucTok_get_next((ucTok*)"t1\0-s1\0t2"), "-s1"));
    UC_TEST_ASSERT(ucTok_equals(ucTok_get_next((ucTok*)"a1\0\na2"), NULL));
    return ucTestErr_NONE;
}

static ucTestErr ucTok_count_counts_tokens(ucTestGroup *p) {
    UC_TEST_ASSERT(0 == ucTok_count((ucTok*)NULL));
    UC_TEST_ASSERT(0 == ucTok_count((ucTok*)"\n"));
    UC_TEST_ASSERT(0 == ucTok_count((ucTok*)"\0\0\0\n"));
    UC_TEST_ASSERT(1 == ucTok_count((ucTok*)"a1\0\n"));
    UC_TEST_ASSERT(1 == ucTok_count((ucTok*)"-s1\0\n"));
    UC_TEST_ASSERT(3 == ucTok_count((ucTok*)"tok en\0a1\0-s1\0\nNA"));
    return ucTestErr_NONE;
}
