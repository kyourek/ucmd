 ...
 */
CL_EXPORTED int cl_arg_opt_get_min_tok_count(cl_arg_opt *p);
 ...
 */
CL_EXPORTED int cl_arg_opt_get_max_tok_count(cl_arg_opt *p);
 ...
 *   A pointer to the newly created argument option.
 */
CL_EXPORTED cl_arg_opt *cl_arg_opt_create_multiple(const char *name, const char *desc, int min_tok_count, int max_tok_count);
 ...
 *   A pointer to the newly created argument option.
 */
CL_EXPORTED cl_arg_opt *cl_arg_opt_create_multiple_numeric(const char *desc, int min_tok_count, int max_tok_count, double numeric_min, double numeric_max);
